...
public class VolunteerDetails extends AppCompatActivity {
    TextView tDetails, tTitle, tQualifications, tTime, tDate;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (getIntent().hasExtra("details") && getIntent().hasExtra("image") && getIntent().hasExtra("title") && getIntent().hasExtra("time") && getIntent().hasExtra("date")) {
